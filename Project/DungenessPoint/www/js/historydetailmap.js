...
function historydetailmapinitialize() {
  var centerPos = new google.maps.LatLng(localStorage.trackhistorylat, localStorage.trackhistorylng);
  var styles = [
  ...
  historydetailmap = new google.maps.Map(document.getElementById('historydetailmapcontent'),mapOptions);


  var marker = new google.maps.Marker({
    position: new google.maps.LatLng(localStorage.trackhistorylat, localStorage.trackhistorylng),
    map:historydetailmap,
    title: localStorage.trackhistorytitle
  });

historydetailmap.setOptions({styles: styles});
}